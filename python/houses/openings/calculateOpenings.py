...
d = '/Users/vonw/data/iaq/houses/SmartHome/YiBo_UTC_WD_CleanedJitter/Atmo10W/'
...
openings = [fn.split('/')[-1].split('.')[0] for fn in fns]
#%%
...
for sensor in sensors:
    if(sensor in validSensors):
        data['T_' + sensor.rstrip()] = (atmo[atmo.location == sensor].Temperature+273.15).resample('1S').ffill().resample('30min').mean()
